...
<div class="row">
    <h1 class="text-center" style="margin-bottom: 15px;">Welcome to Two Framework</h1>
    <br>
...
<div class="row">
    <div class="col-md-6">
        ...
        <ul class="list-unstyled">
            ...
            <?php } else { ?>
            <li><i class='fa fa-close text-danger'></i> Your version of PHP is too low. You need PHP 8.1 or higher to use Two Framework (detected <b><?= PHP_VERSION; ?></b>).</li>
            <?php } ?>
