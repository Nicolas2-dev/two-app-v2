...
class ModuleServiceProvider extends ServiceProvider
{
    ...
    protected $providers = array(
        'Modules\Exemple\Providers\AuthServiceProvider',
        'Modules\Exemple\Providers\EventServiceProvider',
        'Modules\Exemple\Providers\RouteServiceProvider',
    );
    ...
    public function boot()
    {
        ...
        $this->package('Modules/Exemple', 'exemple', $path);
    ...
    /**
     * Enregistrez le fournisseur de services de module Exemple.
     *
